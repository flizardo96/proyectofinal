...
public class Gestor_de_Productos extends javax.swing.JFrame {

    public Gestor_de_Productos() {
        initComponents();
        DefaultTableModel modelo;
String[] titulos={"Id","Nombre","Marca","Categoria","Precio","CantidadDisponible"};
...
abrir.setVisible(true);
      ...
      // objconectar.ejecutarsentenciaSQL("INSERT into productos (NombreProducto , idProducto,MarcaProducto,CategoriaProducto,PrecioProducto,StockProducto)VALUES ('Poloche', null, 'Polo','Ropa',250,10)");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gestor_de_Productos().setVisible(true);
            }
        });
    }
